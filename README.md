...
- Bar: Double Shake
- Sponsor: Carlsberg
- Included: one free picture at Picka pic photo booth
...
- Priority List at `/waitlist`, with duplicate protection, confirmation email, and protected CSV export at `/admin/waitlist`
